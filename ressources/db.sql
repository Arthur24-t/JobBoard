...
INSERT INTO `user` (`user-id`,`user-firstName`, `user-lastName`, `user-email`, `user-phone`, `user-password`, `user-date`, `user-type`) VALUES (1,"admin" , "admin" ,"admin@admin.com", "00000000","$2b$12$38dHVMlNJQ8Gc7lnpUUl1OKxfHimPUHCX4859JArBpv1DvgJFBtl6", "2022-10-16", 1);